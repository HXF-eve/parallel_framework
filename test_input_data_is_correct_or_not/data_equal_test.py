# -*-coding:utf-8-*-
# Author:Xiaowen Peng
# CreateDate: 2020/12/29 19:16
# Description:
import csv

MAFILE = 'MA_online_data.csv'
SAFILE = 'SA_online_data.csv'
...
for i in range(0,len_madata,2):
    ...
    if len(diff_txs_idx) > 0:
        ...
        print("diff txs_sa :",txs_sa[diff_txs_idx])
        print("recording lat_ma :", latency_ma[diff_txs_idx])
        print("recording lat_sa :", latency_sa[diff_txs_idx])
